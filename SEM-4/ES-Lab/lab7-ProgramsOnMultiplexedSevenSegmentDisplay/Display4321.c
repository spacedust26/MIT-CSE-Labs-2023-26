//To display the number 4321 serially in the seven segment display
...
unsigned char dec[10] = {0x3F, 0X06, 0X5B, 0X4F, 0X66, 0X6D, 0X7D, 0X07, 0X7F, 0X6F}; //hex values of 0 to 9
unsigned int dig_value[4] = {4,3,2,1}; //To be displayed
...
void display(void){
	LPC_GPIO1 -> FIOPIN = dig_select[dig_count]; // Enable P1.23-P1.26
